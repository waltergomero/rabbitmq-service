...
export declare function publishMessage(queue: string, message: string): Promise<void>;
export declare function publishToExchange(exchange: string, routingKey: string, message: string): Promise<void>;
